export const database = [ /* "Banco de dados" de produtos comercializados no site */
    {
        ...
        imagemProduto: {
            img1:"images/chapeu/boina.png",
            img2:"./images/imagens/blusa-verde.png",
            img3:"./images/imagens/blusa-verde.png",
            img4:"./images/imagens/blusa-verde.png",
        },
    ...
    },
    {
        ...
        imagemProduto: {
            img1:"./images/imagens/blusa-flor.png",
            img2:"./images/imagens/blusa-flor.png",
            img3:"./images/imagens/blusa-flor.png",
            img4:"./images/imagens/blusa-flor.png",
    },
        categoriaProduto: 'Ferramentas',
        classificacaoProduto:"Novidades",
        exibirHome: true
    },
    {
        ...
        descricao:"A Parafusadeira e Furadeira de Impacto a Bateria de 3/8 Bosch GSB 12V-30, 12V, possui motor sem escovas de carvão a um preço que você nunca viu! Além disso, vem com sistema inteligente ECP que protege eletronicamente as células da bateria.",
        imagemProduto: {
            img1:"./images/imagens/oculos-preto.png",
            img2:"./images/imagens/oculos-preto.png",
            img3:"./images/imagens/oculos-preto.png",
            img4:"./images/imagens/oculos-preto.png",
    ...
    },
    {
        ...
        descricao:"A Parafusadeira e Furadeira de Impacto a Bateria de 3/8 Bosch GSB 12V-30, 12V, possui motor sem escovas de carvão a um preço que você nunca viu! Além disso, vem com sistema inteligente ECP que protege eletronicamente as células da bateria.",
        imagemProduto: {
            img1:"./images/imagens/saia-couro.png",
            img2:"./images/imagens/saia-couro.png",
            img3:"./images/imagens/saia-couro.png",
            img4:"./images/imagens/saia-couro.png",
    ...
    },
    {
        ...
        descricao:"A Parafusadeira e Furadeira de Impacto a Bateria de 3/8 Bosch GSB 12V-30, 12V, possui motor sem escovas de carvão a um preço que você nunca viu! Além disso, vem com sistema inteligente ECP que protege eletronicamente as células da bateria.",
        imagemProduto: {
            img1:"./images/imagens/mini-saia.png",
    ...
    },
    {
        ...
        descricao:"A Parafusadeira e Furadeira de Impacto a Bateria de 3/8 Bosch GSB 12V-30, 12V, possui motor sem escovas de carvão a um preço que você nunca viu! Além disso, vem com sistema inteligente ECP que protege eletronicamente as células da bateria.",
        imagemProduto: {
            img1:"./images/imagens/jaqueta-couro.png",
            img2:"./images/products/prod02/img2.png",
            img3:"./images/products/prod02/img3.png",
            img4:"./images/products/prod02/img4.png",
